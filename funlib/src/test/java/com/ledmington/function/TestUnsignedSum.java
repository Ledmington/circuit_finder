...
public class TestUnsignedSum extends TestLogicFunction {
    ...
    private static Stream<Arguments> signedAdditions() {
        ...
        signedIntegers.put(9, new BitArray("1001"));
        signedIntegers.put(10, new BitArray("1010"));
        signedIntegers.put(11, new BitArray("1011"));
        signedIntegers.put(12, new BitArray("1100"));
        signedIntegers.put(13, new BitArray("1101"));
        signedIntegers.put(14, new BitArray("1110"));
        signedIntegers.put(15, new BitArray("1111"));
